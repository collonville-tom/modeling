            ...
            if (cmd instanceof CreateRelation) {
                ...
                while (itElements.hasNext()) {
                    if (itElements.next().equals(((CreateRelation) cmd).getName())) {
                        ...
                        final Relation relation = (Relation) ((MetaRelation) ((CreateRelation) cmd).getType()).getInstanceIterator().getInstanceAt(relationName);
            ...
            if (cmd instanceof CreateAttribute) {
                ...
                while (itElements.hasNext()) {
                    if (itElements.next().equals(((CreateAttribute) cmd).getName())) {
                        ...
                        final Attribute attribute = (Attribute) ((MetaAttribute) ((CreateAttribute) cmd).getType()).getInstanceIterator().getInstanceAt(attributeName);
