                ...
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'home-ssh-key', keyFileVariable: 'SSH_KEY', usernameVariable: 'SITE_USER')]) {
                        sh '''
                            ...
                            echo "✅ Package déployé avec succès sur https://collonvillethomas.freeboxos.fr/public/depot/"
                        '''
                    }
                }
            }
                ...
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'home-ssh-key', keyFileVariable: 'SSH_KEY', usernameVariable: 'SITE_USER')]) {
                        sh '''
                            ...
                            pwd
                            cd  ./target/staging
                            scp -r ./ ${SITE_USER}@${SERVER_IP}:/mnt/nfs_storage_client/docker_share/tc-public-share/html/projets/${BRANCH_NAME}/modeling
